...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('gridTemplate.html',
    ...
    "\n" +
    "        <div ng-style=\"rowStyle(row)\" ng-repeat=\"row in renderedRows\" ng-click=\"row.toggleSelected($event)\" ng-dblclick=\"options.row.dblClick(row)\"  ng-class=\"row.alternatingRowClass()\" ng-row></div>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    "</div>\r" +
